...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'locations', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Location.timestamp'
        db.alter_column(u'locations', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
