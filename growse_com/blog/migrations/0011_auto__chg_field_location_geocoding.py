...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.geocoding'
        db.alter_column(u'locations', 'geocoding', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'Location.geocoding'
        db.alter_column(u'locations', 'geocoding', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'blog.location': {
            ...
            'geocoding': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
