...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'blog.location': {
            ...
            'timedelta': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '9', 'decimal_places': '3'}),
