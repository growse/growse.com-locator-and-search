...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.accuracy'
        db.alter_column(u'locations', 'accuracy', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'Location.accuracy'
        db.alter_column(u'locations', 'accuracy', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=6))
